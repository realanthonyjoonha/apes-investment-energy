...
**These tools are mandatory for all closing prices, sector ETFs, and commodity proxies.** Web search is only for news and qualitative recap — never for prices. If you find yourself thinking "MMD seems unavailable," call the tool anyway — it IS there. The tool has been verified working in this exact session configuration.
